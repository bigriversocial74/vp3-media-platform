...
$checks=[
 ...
 'src/Network/ViewerCommunityService.php'=>['addComment','toggleLike','toggleBlock','toggleMute','report'],
 ...
 'api/v1/viewer/comments.php'=>['ViewerCommunityService','GET','POST'],
 'api/v1/viewer/comment-action.php'=>['like','delete','report','block','mute'],
 ...
 'assets/js/community.js'=>['data-comments-button','comment-action.php','parent_uuid'],
 'clips.php'=>['data-community-drawer','community.js','data-comments-button'],
