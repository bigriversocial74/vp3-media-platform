...
$extraStyles=['assets/css/reels.css'];$extraScripts=['assets/js/reels.js'];
$pageTitle=$pageTitle??'Viewer Account';$pageDescription=$pageDescription??'Manage your VP3 Clips viewer profile, follows, saved clips, and watch history.';$bodyClass=trim(($bodyClass??'').' viewer-account-page');
