...
<footer class="site-footer">
  <div class="footer-intro">
    <a class="brand footer-brand" href="<?= vp3_e(vp3_url('index.php')) ?>">
  ...
  <div><h4>Products & company</h4><a href="<?= vp3_e(vp3_url('services.php')) ?>">Creative services</a><a href="<?= vp3_e(vp3_url('book-demo.php')) ?>">Book a demo</a><a href="<?= vp3_e(vp3_url('products.php')) ?>">Products</a><a href="<?= vp3_e(vp3_url('pricing.php')) ?>">Pricing</a><a href="<?= vp3_e(vp3_url('demo.php')) ?>">Demo</a><a href="<?= vp3_e(vp3_url('about.php')) ?>">About VP3</a><a href="<?= vp3_e(vp3_url('contact.php')) ?>">Contact</a><a href="<?= vp3_e(vp3_url('support.php')) ?>">Support</a></div>
  ...
  <div class="footer-cta"><span class="eyebrow">Your story deserves a home</span><h3>Launch an experience your audience can belong to.</h3><a class="button" href="<?= vp3_e(vp3_url('book-demo.php')) ?>">Plan your launch</a></div>
