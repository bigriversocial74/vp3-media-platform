...
$adminLinks=[
 ...
 ['customers.view','admin/viewers.php','Viewers'],
 ...
 ['sales.view','admin/leads.php','Sales pipeline'],
 ['sales.view','admin/demo-requests.php','Demo requests'],
 ['sales.view','admin/service-packages.php','Service packages'],
 ['sales.view','admin/proposals.php','Proposals'],
 ['projects.view','admin/project-briefs.php','Project briefs'],
 ['projects.view','admin/projects.php','Creative projects'],
 ['network.view','admin/creators.php','Creators'],
 ['network.view','admin/shows.php','Shows'],
 ['clips.moderate','admin/clips.php','Clip moderation'],
 ['clips.moderate','admin/community-moderation.php','Community moderation'],
